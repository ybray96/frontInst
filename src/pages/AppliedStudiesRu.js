...
import AppliedStudiesCardRu from "../components/Cards/AppliedStudiesCardRu";
import useVisualImpairmentScript from "../components/Hooks/useEye";

function AppliedStudiesRu() {
  useEffect(() => {
  ...
  return (
    <div className="w-full absolute bg-[#e4e4e4] font-nunito ">
      <div
       className="xl:h-[500px] md:h-full h-[150px]  relative"F
        style={{
...
export default AppliedStudiesRu;
