...
import thenewsbg from "../components/images/thenewsbg.png";
import TheNewsCard from "../components/Cards/TheNewsCard";
  ...
  return (
    <div className="w-full bg-[#e4e4e4]  ">
      <div
        ...
        style={{
          backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url(${thenewsbg})`,
      ...
      >
                    ...
                    <div className="burger-menu z-50 ">
                      <div className="lg:hidden ">
                        ...
                        <div
                          ...
                          } lg:hidden   top-0 left-0 h-full fixed  bg-[#e4e4e4] transition-transform duration-400 ease-in-out lg:translate-x-0 lg:static lg:h-auto lg:bg-transparent lg:duration-0 lg:ease-none lg:opacity-100 lg:w-full max-w-screen-xl`}
                        >
                          <button
        ...
        <div className="mx-auto max-w-screen-xl   mt-28 sm:mt-32 flex flex-col"></div>
      </div>
      <TheNewsCard />
