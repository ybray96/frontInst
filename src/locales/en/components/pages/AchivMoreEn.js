...
import ourachievements from "../../../../components/images/achievement.png";

import { Link } from "react-router-dom";
import useVisualImpairmentScript from "../../../../components/Hooks/useEye";
function AchivMoreEn() {
  useEffect(() => {
                      ...
                      <div className="relative inline-block text-white">
                        ...
                        {isDropdownOpen && (
                          <div className="absolute z-10 mt-3 ml-4  w-[80px] bg-black  divide-y divide-gray-200 rounded-lg shadow-lg">
                            <ul>
                              <Link to="/en/theachievement/:cardId">
                                <li
                              ...
                              <Link to="/ru/theachievement/:cardId">
                                {" "}
                                <li
