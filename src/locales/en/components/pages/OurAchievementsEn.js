...
import AchievementsCardEn from "../Cards/AchievementsCardEn";
import useVisualImpairmentScript from "../../../../components/Hooks/useEye";

function OurAchievementsEn() {
  useEffect(() => {
  ...
  return (
    <div className="w-full bg-[#e4e4e4]  ">
      <div
        ...
        style={{
          backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url(${ourachievements})`,
    ...
    />
        ...
        <div className=" mt-52 sm:mt-52 mx-auto max-w-screen-xl   ">
          <div className="p-4 text-white text-lg sm:text-3xl  font-semibold   "></div>
        </div>
      </div>
...
export default OurAchievementsEn;
