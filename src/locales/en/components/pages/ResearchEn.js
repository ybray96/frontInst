...
import ResearchCardEn from "../Cards/ResearchCardEn";
import research2 from "../../../../components/images/research2.png";
  ...
  return (
    <div className="w-full absolute bg-[#e4e4e4] font-montserrat ">
      <div
        ...
        style={{
          backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url(${research2})`,
      ...
      >
        ...
        <div className=" md:mt-52  mt-[250px] xl:mt-48 lg:mt-48 mx-auto max-w-screen-xl   ">
          <div className="p-4 text-white text-lg sm:text-3xl  font-semibold   ">
            «The study of traditional crafts of modern Kazakhstan: the state and
            search for ways to preserve»
          </div>
        </div>
      </div>
