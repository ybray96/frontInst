...
import ExVisionImage from "../../../../components/images/2023-07-26-twt-cover-package-loyn-taliban-horsemen.jpg.png";
    ...
    <div className="w-full bg-[#e4e4e4]  ">
      ...
      >
        ...
        <div className=" mt-52 sm:mt-48 mx-auto max-w-screen-xl   ">
          <div className="p-4 text-white text-lg sm:text-3xl  font-semibold   ">
            {/* «The history of independent Kazakhstan is the history of the desire for
          prosperity and harmony in a multinational society.» */}
          </div>
        </div>
      </div>
      ...
      <div className="flex flex-col mx-auto max-w-screen-xl px-4 py-2">
        ...
        <div className="flex justify-center mt-8">
          {[
            ...Array(Math.ceil(filteredNewsData.length / itemsPerPage)).keys(),
          ].map((pageNumber) => (
            <button
              key={pageNumber}
