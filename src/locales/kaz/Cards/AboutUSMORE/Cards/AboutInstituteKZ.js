              ...
              <nav className=" flex flex-col mx-auto  max-w-screen-xl">
                <div className=" relative flex  justify-between items-center sm:flex-row sm:items-center">
                  ...
                  <div className="flex items-center gap-4 sm:gap-4">
                    <div className=" lg:block hidden   hover:scale-110">
                      <div className="hidden sm:flex flex-row items-center w-full h-10 px-2 rounded-lg bg-transparent">
                        <input
                          type="search"
                          className="flex-1 w-full h-full px-2 text-white bg-transparent focus:outline-none"
                        />
                    ...
                    <ul>
                      {isOpen && (
                        <div className="absolute  bg-black  top-full right-0 mt-2  space-y-2  shadow-md rounded-lg">
                          ...
                          <button className="text-white whitespace-nowrap font-medium rounded-lg text-md px-5 py-2.5 text-center inline-flex hover:scale-110  items-center">
                            Ғылыми басылымдар
                          </button>
                          <Link to="/recommendations">
                            {" "}
                            <button className="text-white whitespace-nowrap font-medium rounded-lg text-md px-5 py-2.5 text-left inline-flex hover:scale-110  items-center">
                              Ұсынымдар
                            </button>
                          </Link>
...
export default AboutInstituteKZ;
