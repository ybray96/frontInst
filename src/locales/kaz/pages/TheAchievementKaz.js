...
import achiv from "../../../components/images/achievement.png";
import TheAchievementCardKaz from "../Cards/TheAchievementCardKaz";
import { useParams } from "react-router-dom";
import useVisualImpairmentScript from "../../../components/Hooks/useEye";
function HistoryInfoCards() {
  useEffect(() => {
  ...
  let cardDate = "";
  if (cardId === "1") {
    cardDate = `25 желтоқсанның 1990 жылы`;
  } else if (cardId === "2") {
    cardDate = `16 желтоқсанның 1991 жылы`;
  } else if (cardId === "3") {
    cardDate = `30 тамыздың 1995 жылы`;
  } else if (cardId === "4") {
    cardDate = ``;
  } else if (cardId === "5") {
    cardDate = ``;
  ...
  return (
    <div className="w-full bg-[#e4e4e4]  ">
      <div
        className="relative bg-cover bg-center xl:h-[580px] md:h-[50vh] h-[25vh]"
        style={{
          backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.2), rgba(0, 0, 0, 0.5)), url(${achiv})`,
    ...
    />
        ...
        <div className=" mt-12 sm:mt-48 xl:mt-[300px] lg:mt-[180px] md:mt-[250px] mx-auto max-w-screen-xl   ">
