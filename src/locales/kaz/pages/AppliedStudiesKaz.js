...
import AppliedStudiesCardKaz from "./AppliedStudiesCArdKaz";
import useVisualImpairmentScript from "../../../components/Hooks/useEye";

function AppliedStudiesKaz() {
  useEffect(() => {
  ...
  return (
    <div className="w-full absolute bg-[#e4e4e4] font-['Source Serif Pro'] ">
      <div
...
export default AppliedStudiesKaz;
