...
import NewsCardKaz from "../Cards/NewsCardKaz";
import useVisualImpairmentScript from "../../../components/Hooks/useEye";

function NewsBlockKaz() {
  useEffect(() => {
  ...
  return (
    <div className="w-full absolute bg-[#e4e4e4]">
      <div
        ...
        style={{
          backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url(${newsbg})`,
    ...
    />
        ...
        <div className="mx-auto max-w-screen-xl   mt-28 sm:mt-32 flex flex-col">
          <div className="px-4 m-1/3 mb-2"></div>
        </div>
      </div>
