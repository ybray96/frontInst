...
import ExVisionCardKaz from "../Cards/ExVisionCardKaz";
...
function ExVisionKaz() {
  useEffect(() => {
    // When the component mounts, scroll the page to the top
    window.scrollTo(0, 0);
  }, []);
  ...
  return (
    <div className="w-full absolute bg-[#e4e4e4] font-nunito">
      ...
      >
        ...
        <div className="md:mt-64 mt-[300px] xl:mt-52 lg:mt-48  mx-auto max-w-screen-xl  ">
