...
import library from "../../../components/images/library.png";

import LibraryCardKaz from "../Cards/LibraryCardKaz";
  ...
  return (
    <div className="w-full bg-[#e4e4e4]  ">
      <div
        ...
        style={{
          backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url(${library})`,
      ...
      >
        ...
        <div className="mx-auto max-w-screen-xl   ">
          <div className=" mt-60 sm:mt-40 mx-auto max-w-screen-xl   ">
