...
import historybg from "../../../components/images/historybg.png";

import historymob from "../../../components/images/historymob.png";
import historypad from "../../../components/images/historypad.png";
import HistoryCardKaz from "../Cards/HistoryCardKaz";
  ...
  useEffect(() => {
    const handleResize = () => {
      if (window.innerWidth <= 480) {
        setBackgroundImage(historymob);
      } else if (window.innerWidth <= 768) {
        setBackgroundImage(historypad);
      } else {
    ...
    handleResize(); // Set the initial background image based on screen width
  ...
  return (
    <div className="w-full bg-[#e4e4e4]  ">
      ...
      >
        ...
        <div className=" mt-48 sm:mt-48 mx-auto max-w-screen-xl   ">
          <div className="p-4 text-white text-3xl font-semibold   "></div>
        </div>
      </div>
