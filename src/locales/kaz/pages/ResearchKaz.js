...
import ResearchCardKaz from "../Cards/ResearchCardKaz";
import useVisualImpairmentScript from "../../../components/Hooks/useEye";

function ResearchKaz() {
  ...
  return (
    <div className="w-full absolute bg-[#e4e4e4]">
      ...
      >
        ...
        <div className=" px-4 mx-auto max-w-screen-xl   md:mt-52  mt-[250px] xl:mt-48 lg:mt-48 "></div>
      </div>
      <ResearchCardKaz />
