  ...
  return (
    ...
    <Router>
      <Routes>
        ...
        <Route path="/en/aboutus/AboutInstitute" element={<AboutInstituteEn />}>
          {" "}
        </Route>
        <Route path="/en/aboutus/Management" element={<ManagementEn />}></Route>
        <Route path="/en/appliedstudies" element={<AppliedStudiesEn />}></Route>
        <Route path="/en/recommendations" element={<RecomendationEn />}></Route>
